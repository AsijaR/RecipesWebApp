        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    State = table.Column<string>(type: "text", nullable: true),
                    Zip = table.Column<string>(type: "text", nullable: true),
                    DateMealShouldBeShipped = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    ServingNumber = table.Column<int>(type: "integer", nullable: false),
                    NoteToChef = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateCommentIsPosted = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ServingNumber = table.Column<int>(type: "integer", nullable: false),
                    TimeNeededToPrepare = table.Column<string>(type: "text", nullable: true),
                    Description = table.Column<string>(type: "text", nullable: true),
                    Note = table.Column<string>(type: "text", nullable: true),
                    MealCanBeOrdered = table.Column<bool>(type: "boolean", nullable: false),
                    Price = table.Column<float>(type: "real", nullable: false),
                    NoteForShipping = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecipeBookmarks", x => new { x.RecipeId, x.BookmarkId });
                    table.ForeignKey(
                        name: "FK_RecipeBookmarks_Bookmarks_BookmarkId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecipeCommments", x => new { x.RecipeId, x.CommentId });
                    table.ForeignKey(
                        name: "FK_RecipeCommments_Comments_CommentId",
                        column: x => x.CommentId,
                        principalTable: "Comments",
                        principalColumn: "CommentId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RecipeCommments_Recipes_RecipeId",
                        column: x => x.RecipeId,
                        principalTable: "Recipes",
                        principalColumn: "RecipeId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecipeBookmarks_BookmarkId",
                table: "RecipeBookmarks",
                column: "BookmarkId");

            migrationBuilder.CreateIndex(
                name: "IX_RecipeCommments_CommentId",
                table: "RecipeCommments",
                column: "CommentId");
